...
import { optionsexperince, optionsDepartment, DepartmentData } from "@/Data/staticData";
        ...
        return (
          <>
            ...
            <div className="flex flex-row w-full">
              <div className="flex flex-col mt-10 w-[33%]">
                <label
              ...
              <div className="mb-10" />
              <div className="flex flex-col mt-10 w-[33%]  ml-5">
                <label
