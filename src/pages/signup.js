...
const Signup = () => {
  ...
  return (
    ...
    <div className="lg:w-[60%] w-full pt-5">
      ...
      <Particles
                className="fixed inset-0 z-0" // Add appropriate classes or styles to position the particles
                quantity={200}
                staticity={30}
                ease={60}
                ...
                vy={0.2}
              />
        <div className="h-3/5 border-2 z-50 border-gray-200 rounded w-96 p-4">
