...
function AirbnbCard({ jobPosts }) {
    ...
    return (
        <div className='flex'>
           <div>
           <h1 className='text-center text-5xl top-10  mt-5'>Opportunity for Students</h1>
                                    ...
                                    <Card>
                                        <div className="md:flex gap-4 items-center">
                                            ...
                                            <div className="grid md:grid-cols-4 grid-cols-3 gap-2 md:text-left w-full text-center">
                                                ...
                                                <Button
                            className="bg-black p-2 w-32 rounded-lg hover:scale-110 hover:bg-green-500 text-white"
                            onClick={() =>
                              router.push(`/jobdetails?id=${jobPost._id}`)
                            }
                          >
                            View Details
                          </Button>
  ...
  {/* Buttons for scrolling */}
  <div className="flex flex-col space-y-10 z-20  mt-96 mr-44 h-44  justify-center ">
