...
const WorkExperience = ({
  ...
  return (
    <div>
      <label className="block mb-2 font-spartan text-lg text-black">
      ...
      {formData.hasWorkExperience === "Yes" && (
        <div className="mt-5 ">
          <label className="block mb-2 font-spartan  text-black">
                ...
                <div className={`${styles.cardheader} justify-between`}>
                  ...
                  <div className="mt-2">
                    <button
                      ...
                      className="bg-[#2E3192] text-white  text-sm p-1 rounded hover:bg-red-600"
                    >
                      Delete
                    </button>
                  </div>
          ...
          <div className="mt-5 lg:grid text-black lg:grid-cols-2 lg:gap-5">
            <div>
              {" "}
