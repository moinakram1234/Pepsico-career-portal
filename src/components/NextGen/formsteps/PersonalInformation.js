...
const PersonalInformation = ({
  ...
  // };
  return (
    <div className="lg:grid z-50  lg:grid-cols-2 lg:gap-4">
      <div>
        <label className=" font-spartan text-black block mb-2">
          Full Name
      ...
      <div>
        ...
        <div className="mb-4">
          <label className=" font-spartan text-black mr-4">
            <input
              type="radio"
              name="gender"
              value="Male"
      ...
      {/* <div>
        <label className=" text-black block mb-2">Spoken languages
      ...
      <div className="relative  lg:h-full">
        ...
        <div className="lg:absolute lg:bottom-0 w-full">
          {errorlist.fileType && (
            <span className="text-red-500">{errorlist.fileType}</span>
          )}
          {errorlist.fileSize && (
            <span className="text-red-500"> {errorlist.fileSize}</span>
          )}
        </div>
      </div>
    </div>
