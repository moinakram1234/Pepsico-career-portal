...
const EducationInformation = ({
  ...
  return (
    <div className="h-full">
            ...
            <div className={`${styles.cardheader} justify-between`}>
              ...
              <div className="">
                <button
                  ...
                  className="bg-[#2E3192] font-spartan text-white p-1 text-sm rounded hover:bg-red-600"
                >
                  Delete
                </button>
              </div>
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-5">
        <div className="">
          <label className="text-black font-spartan  block mb-2">
            Degree Name
        ...
        {/* <div>
     <label className="text-black block mb-2">Result Type</label>
      <select
        name="ResultType"
      ...
      >
        ...
        <div className="mb-3">
          <label className="text-black block mb-2">Percentage</label>
          <input
            type="text"
            name="percentage"
   ...
   */}
        ...
        <div>
          <label className="text-black block mb-2 font-spartan ">
